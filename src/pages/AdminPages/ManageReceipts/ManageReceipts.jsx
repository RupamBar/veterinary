...
function ManageReceipts() {
  ...
  const getAllReceipts = async () => {
    try {
      const res = await axios.get(`${config.backend_URL}/getAllReceipts`);
    ...
    <div>
      ...
      <div className="adminPageBg">
        ...
        >
          ...
          <div className="adminPageHeading">Receipts of Food Purchase</div>
        </div>
