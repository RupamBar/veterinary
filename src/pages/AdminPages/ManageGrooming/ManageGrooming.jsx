...
function ManageGrooming() {
  ...
  // console.log(groomingList, "GroomingList");
  ...
  const getAllGroomings = async () => {
    try {
      const res = await axios.get(`${config.backend_URL}/getAllGroomings`);
      setGroomingList(res?.data?.data);
    } catch (err) {
  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: (params) => {
        // console.log(params, "params");
        return params?.row?.employees?.name;
      },
    },
    {
      field: "slots",
    ...
    <div>
      ...
      <div className="adminPageBg">
        ...
        >
          ...
          <div className="adminPageHeading">Grooming Records</div>
        </div>
