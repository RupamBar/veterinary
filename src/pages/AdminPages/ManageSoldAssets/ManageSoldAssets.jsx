...
function ManageSoldAssets() {
  ...
  const [soldAssetsList, setSoldAssetsList] = useState([]);
  // console.log(SoldAssetsList, "SoldAssetsList");
  ...
  const getAllSoldAssets = async () => {
    try {
      const res = await axios.get(`${config.backend_URL}/getAllSoldAssets`);
      setSoldAssetsList(res?.data?.data);
    } catch (err) {
    ...
    <div>
      ...
      <div className="adminPageBg">
        ...
        >
          ...
          <div className="adminPageHeading">Receipts of Assets Purchase</div>
        </div>
...
export default ManageSoldAssets;
